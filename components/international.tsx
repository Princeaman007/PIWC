...
const OverlayText = () => {
  return (
    ...
    <div className="relative border border-8 border-solid border-orange-500">
      <Image 
      ...
      <div className="inset-0 bg-black bg-opacity-80 flex items-center justify-center z-15 p-4">
        <div className="text-white space-y-4 text-center ">
            <span className="block text-center md:text-5xl text-xl font-bold border border-8 border-orange-500">PENTECOST INTERNATIONAL CHURCH</span>
          <p>
